...
@section('content')
    ...
    <div class="col-md-12" style="margin-bottom: 10px;">
        <div class="d-flex justify-content-end">
            <a href="{{ route('produto.listagem')}}" class="btn btn-info"><i class="fa fa-arrow-left"></i>&nbsp; Voltar</a>
        </div>
    </div>
    <div class="col-lg-12">
        @if (session('error'))
        ...
        <div class="card">
            <div class="card-header">
                <strong class="card-title">Cadastro de novos produtos</strong>
            </div>
            <div class="card-body card-block">
                <form action="{{ route('produto.inserir') }}" method="post" class="">
                    @csrf
                    <div class="row">
                        <div class="col-md-4">
